...
public class Folder extends AbstractFloatingView implements DragSource,
    ...
    void bind(FolderInfo info) {
        ...
        if (lp == null) {
            lp = new BaseDragLayerLayoutParams(0, 0);
    ...
    private void closeComplete(boolean wasAnimated) {
        ...
        if (mFolderIcon != null) {
            ...
            mFolderIcon.folderName.setTextVisibility(true);
            if (wasAnimated) {
                mFolderIcon.background.fadeInBackgroundShadow();
                mFolderIcon.background.animateBackgroundStroke();
